...
public class DemoObject {
  ...
  public static void main(String[] args) {
    ...
    Cat1 c1 = new Cat1("Lucas", 10, 2.3);

    Animal1 a1 = new Cat1("Leo", 3, 2.4);
    ...
    Cat1 c2 = (Cat1) o1;       // 強行 assign, 有機會 down 機, 後果自負.
    System.out.println(c2.getName());          // Lucas

    Cat1 c3 = new Cat1("Lucas", 2, 3.4);
    ...
    Shape1 s1 = new Circle(3.5, "RED");      // Polymorphism
    Shape1 s2 = new Square(8, "BLACK");      // Polymorphism
    Shape1 s3 = new Circle(4, "BLUE");       // Polymorphism
    ...
    Shape1[] shapes = new Shape1[] {s1, s2, s3};
